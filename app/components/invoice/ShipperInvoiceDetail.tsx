    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center p-2 sm:p-4 z-50 overflow-y-auto">
        ...
        <Alert
          ...
          onClose={() => {
            ...
            if (alertType === "success") {
              onClose(); // This will trigger the navigation in the parent component
            }
          }}
          autoClose={false}
        />
      ...
      {showReceipt ? (
        <div className="receipt-container">
          {/* Add your receipt component here */}
          <h2>Payment Receipt</h2>
          {/* Add receipt details */}
        </div>
      ) : (
        <div
          className={`${themeClasses.modal} w-full max-w-4xl rounded-lg shadow-xl relative my-2 sm:my-8`}
        >
            ...
            {invoice.status !== "paid" && (
              <Form method="post">
                ...
                <button
                  ...
                  value="Pay"
                  disabled={
                    isProcessing || !termsAccepted || !serviceFeesAccepted
                  }
                  className={`w-full py-2 sm:py-3 px-4 rounded-md font-medium transition-colors duration-300 relative ${
                    ...
                    !termsAccepted || !serviceFeesAccepted || isProcessing
                ...
                >
                  {isProcessing ? (
                    ...
                    `Pay ETB ${invoice.amountDue.toLocaleString()}`
                  )}
                </button>
              </Form>
            )}
