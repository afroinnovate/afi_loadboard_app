      ...
      <div className="bg-white rounded-lg p-6 max-w-sm w-full space-y-4">
        ...
        <div>
          ...
          <p className="text-sm italic ">
            ...
            <span className="text-green-500 font-semibold">
              {shipper.businessProfile.companyName}
            </span>
          </p>
          <p className="text-sm italic">
            Registration Number:{" "}
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <p>
              Email:{" "}
              <span className="text-blue-600 underline italic cursor-pointer">
                {shipper.email}
              </span>
            </p>
            <button
          ...
          <div className="flex items-center justify-between">
            <p>
              Phone:{" "}
              <span className="text-blue-600 underline italic cursor-none">
                {shipper.phone}
              </span>
            </p>
            <button
