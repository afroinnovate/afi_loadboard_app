...
export default function ShipperHeader({ isAuthenticated, isLoadOperationsActive, toggleMenu }) {
    return (
        <div className="flex flex-col space-y-4">
          {/* If the shipper hasn't logged in */}
            {!isAuthenticated && (
              <>
            ...
            {isAuthenticated && (
                <>
                  ...
                  <div className="pl-2 m-2">
                    <Link 
                      onClick={toggleMenu}
                      to="/shipper/dashboard/view" className="px-3 py-4 items-center text-green-700 font-extrabold font-sans hover:underline hover:translate-y-1 hover:translate-x-2">
                      PickUp Load Now
                    </Link>
                  </div>
