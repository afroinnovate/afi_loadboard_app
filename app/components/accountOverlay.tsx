...
export default function AccountOverlay({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 top-16 bg-gray-800 bg-opacity-75 flex z-50">
        ...
        <div className="flex h-full">
          <div className="w-1/4 bg-gray-100 p-4">
            <ul>
              ...
              <li className="mb-4">
                <Link to={`${basePath}/business`} className="flex items-center text-green-900 hover:bg-gray-200">
                  <InformationCircleIcon className="w-5 h-5 mr-2" />
                  Business Information
                </Link>
              </li>
              <li className="mb-4">
                <Link to={`${basePath}/subscriptions`} className="flex items-center text-green-900 hover:bg-gray-200">
                  <CogIcon className="w-5 h-5 mr-2" />
                  Subscription
                </Link>
              </li>
              <li className="mb-4">
                <Link to={`${basePath}/help`} className="flex items-center text-green-900 hover:bg-gray-200">
          ...
          <div className="w-3/4 p-6 overflow-y-auto overflow-auto">
            <Outlet />
          </div>
        </div>
      </div>
