...
export default function Sidebar({
  ...
  return (
    <aside
      className={`w-64 shadow-lg h-screen overflow-y-auto py-4 px-3 ${themeClasses.header} rounded`}
      aria-label="Sidebar"
    >
        ...
        {renderingLinks.map((link) => (
          <li key={link.name}>
            ...
            >
              {link.name === "Overview" && (
                <svg
                  className={`h-6 w-6 mr-3 ${themeClasses.iconColor} ${themeClasses.iconHover} transition-colors duration-200`}
                  fill="currentColor"
                  viewBox="0 0 20 20"
